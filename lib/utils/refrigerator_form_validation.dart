...
final refrigeratorFormProvider =
  ...
  return FormGroup({
    ...
    'purchaseDate': FormControl(validators: [
      Validators.required,
      Validators.pattern(RegExp(
          r'^\d{4}-\d{2}-\d{2}$'))
    ]),
    'expirationDate': FormControl(validators: [
      Validators.required,
      Validators.pattern(RegExp(r'^\d{4}-\d{2}-\d{2}$'
    ...
    'marketName': FormControl(validators: [Validators.required]),
