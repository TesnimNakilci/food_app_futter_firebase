...
import 'package:food_app_flutter/presentation/components/tip_card.dart';
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => HomePage(ndx: 6)),
            );
          ...
          ) // const Icon(Icons.receipt,color: AppColors.milkWhite,),
          ),
